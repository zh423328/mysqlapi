...
// Index that returns last cab file opened, this is needed to get the name of
// original cab file since debugger returns the extracted dump file in GetDumpFile APIs
...
#define DEBUG_ENGOPT_ALL                         0x00003FFF
