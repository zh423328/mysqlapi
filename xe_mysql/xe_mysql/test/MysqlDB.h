...
#ifdef DLL_FILE
class _declspec(dllexport)MySqlDB 
#else
class _declspec(dllimport)MySqlDB 
#endif
{
private:
	friend	MySqlQuery;
...
#ifdef DLL_FILE
_declspec(dllexport) bool IsThreadSafe();
#else
_declspec(dllimport) bool IsThreadSafe();	
#endif

#ifdef DLL_FILE
class _declspec(dllexport)MySqlQuery 
#else
class _declspec(dllimport)MySqlQuery 
#endif
{
private:
...
#ifdef DLL_FILE
class _declspec(dllexport)MySqlCmd 
#else
class _declspec(dllimport)MySqlCmd 
#endif
{
private:
	class ValueNode
